...
void clusterKptMatchesWithROI(BoundingBox &boundingBox_c, std::vector<cv::KeyPoint> &kptsPrev, std::vector<cv::KeyPoint> &kptsCurr, std::vector<cv::DMatch> &kptMatches);
