...
Training, Guard cells and offset are selected by increasing and decreasing to match the image shared in walkthrough. The CFAR_sig array is initialized to all zeros so that non-thresholded values will be resolved to zero.
